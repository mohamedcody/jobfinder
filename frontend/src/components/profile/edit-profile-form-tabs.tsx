...
export function EditProfileFormTabs({
  ...
  const handleChange = (
    ...
    validateField(name, newValue as string | number | boolean);
  };
          ...
          {currentTab === "professional" && (
            <div className="space-y-4">
              ...
              <div className="space-y-2 p-4 rounded-xl bg-white/2 border border-white/5">
                <FieldHelp label="Skills" help="Add your key skills. Use commas or press Enter." />
                <div className="flex flex-col gap-3">
                  <div className="flex flex-col sm:flex-row gap-2">
                    ...
                    <Button
                      ...
                      className="shrink-0 bg-violet-600 hover:bg-violet-700 text-white font-bold"
                    >
                      Add
                    </Button>
                  </div>
                  <p className="text-xs text-slate-400">
                    Tip: You can paste a comma-separated list and press Add.
                  </p>
                </div>
