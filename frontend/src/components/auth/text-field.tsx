      ...
      <div className="relative group mb-1">
        ...
        <div className="relative">
          ...
          <input
            ...
            className={`w-full rounded-xl border border-white/10 bg-white/[0.03] px-3.5 py-3 text-sm text-white shadow-inner placeholder:text-slate-500 transition-all duration-300 focus:outline-none focus:border-cyan-400/60 focus:bg-white/10 focus:ring-4 focus:ring-cyan-400/15 ${Icon ? 'pl-11' : ''}`}
            {...props}
          />
        </div>
        {error ? (
