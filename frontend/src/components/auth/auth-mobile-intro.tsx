...
const mobileStats = [
  { label: "Active opportunities", value: "12K+", icon: TrendingUp, gradientClass: "metric-orange" },
  { label: "Positive experience", value: "98%", icon: BadgeCheck, gradientClass: "metric-sun" },
  { label: "Application tracking", value: "24/7", icon: Clock3, gradientClass: "metric-green" },
  { label: "Secure verification", value: "OTP", icon: ShieldCheck, gradientClass: "metric-purple" },
];
    ...
    <section className="showcase-panel page-fade w-full rounded-3xl p-6 sm:p-8 lg:hidden">
      ...
      <div className="mt-7 grid grid-cols-2 gap-3 sm:gap-4">
        {mobileStats.map((item) => {
          ...
          return (
            <div key={item.label} className={`metric-chip metric-chip-gradient ${item.gradientClass}`}>
      ...
      <div className="mt-7 rounded-2xl border border-cyan-300/30 bg-slate-900/35 p-4">
